...
func CounterSt(t *theme.Theme, cc *Counter) CounterStyle {
	return CounterStyle{
		...
		increase: iconButton(t.T, t.Icons["CounterPlus"], cc.CounterIncrease, t.Colors["Primary"]),
		decrease: iconButton(t.T, t.Icons["CounterMinus"], cc.CounterDecrease, t.Colors["Primary"]),
...
func (c CounterStyle) Layout(g layout.Context, th *theme.Theme, label, value string) func(gtx layout.Context) layout.Dimensions {
								...
								return layout.Inset{
									...
									return layout.Flex{
										...
										layout.Rigid(func(gtx layout.Context) layout.Dimensions {
											...
											return material.Caption(th.T, label).Layout(gtx)
