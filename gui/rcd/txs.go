...
func (r *RcVar) GetSingleTx(txid string) func(gtx layout.Context) layout.Dimensions {
...
//}
//
//func (r *RcVar) GetDuoUItransactions() func(gtx layout.Context)layout.Dimensions{
//	return func(gtx layout.Context)layout.Dimensions{
...
// func (r *RcVar) GetTransactions() func(gtx layout.Context)layout.Dimensions{
//	return func(gtx layout.Context)layout.Dimensions{
//		Debug("getting transactions")
