...
func (r *RcVar) ShowAddressBook() func(gtx layout.Context) layout.Dimensions {
...
func (r *RcVar) GetAddressBook() func(gtx layout.Context) layout.Dimensions {
	return func(gtx layout.Context) layout.Dimensions {
		...
		//			Amount:  addr.Amount,
		//			Copy:    new(widget.Clickable),
		//			QrCode:  new(widget.Clickable),
		//		})
		//	}
		//}
		//sort.Sort(addrs)
