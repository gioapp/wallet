...
func (r *RcVar) GetSingleBlock(hash string) func(gtx layout.Context) layout.Dimensions {
...
//	b.Time = block.Time
//
//	b.Link = &widget.Clickable{}
//	return
//}
//
//func (r *RcVar) GetBlocksExcerpts() func(gtx layout.Context)layout.Dimensions{
//	return func(gtx layout.Context)layout.Dimensions{
